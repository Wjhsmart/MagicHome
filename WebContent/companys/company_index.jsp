...
<script type="text/javascript">
	...
	function refresh() {
		window.location.href="<%=path %>/company/return_index_page";
	}
</script>
<style type="css/text">
...
<body class="easyui-layout">
	...
	<div region="west" border="true" split="true" title="导航" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
			<div title="个人中心">
				<a href="javascript:void(0);" src="<%=path %>/company/query_personal_mes_page"
					class="cs-navi-tab">查看个人信息</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/company/update_personal_pwd_page"
					class="cs-navi-tab">修改密码</a>
				<p></p>
			</div>
			<div title="案例管理">
				<a href="javascript:void(0);" src="<%=path %>/company/company_add_case_page"
					class="cs-navi-tab">添加案例</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/company/query_case_all_page"
					class="cs-navi-tab">查看所有案例</a>
				<p></p>
			</div>
			<div title="活动管理">
				<a href="javascript:void(0);" src="<%=path %>/company/company_add_activity_page"
					class="cs-navi-tab">添加活动</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/company/company_activity_page"
					class="cs-navi-tab">查看所有活动</a>
				<p></p>
			</div>
			<div title="预约管理">
				<a href="javascript:void(0);" src="<%=path %>/company/query_not_audit_appointment"
					class="cs-navi-tab">查看未接受的预约</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/company/query_audit_appointment"
					class="cs-navi-tab">查看已接受的预约</a>
				<p></p>
			</div>
		</div>
	</div>
