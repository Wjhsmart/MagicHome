...
<script type="text/javascript">
	...
	function refresh() {
		window.location.href="<%=path %>/customer/return_index_page";
	}
</script>
<style type="css/text">
...
<body class="easyui-layout">
	...
	<div region="west" border="true" split="true" title="导航" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
			<div title="个人中心">
				<a href="javascript:void(0);" src="<%=path %>/customer/query_personal_mes_page"
					class="cs-navi-tab">查看个人信息</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/customer/update_personal_pwd_page"
					class="cs-navi-tab">修改密码</a>
				<p></p>
			</div>
			<div title="装修公司">
				<a href="javascript:void(0);" src="<%=path %>/customer/query_company_col_page"
					class="cs-navi-tab">查看已收藏的装修公司</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/customer/query_company_col_case_page"
					class="cs-navi-tab">查看已收藏的装修公司案例</a>
				<p></p>
			</div>
			<div title="设计师">
				<a href="javascript:void(0);" src="<%=path %>/customer/query_designer_col_page"
					class="cs-navi-tab">查看已收藏的设计师</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/customer/query_designer_col_case_page"
					class="cs-navi-tab">查看已收藏的设计师案例</a>
				<p></p>
			</div>
			<div title="建材商">
				<a href="javascript:void(0);" src="<%=path %>/customer/query_product_col_page"
					class="cs-navi-tab">查看已收藏的建材商品</a>
				<p></p>
			</div>
		</div>
	</div>
