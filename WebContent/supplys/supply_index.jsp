...
<script type="text/javascript">
	...
	function refresh() {
		window.location.href="<%=path %>/supply/return_index_page";
	}
</script>
<style type="css/text">
...
<body class="easyui-layout">
	<div region="north" border="true" class="cs-north">
		<div class="cs-north-bg">
			<div class="cs-north-logo" style="position: relative; margin-left: 30px;">
				...
				<a href="<%=path %>/page/index" >建材商后台管理</a>
				<span style="margin-left: 40px; font-size: 16px;">欢迎您，${sessionScope.supply.name }</span>
	...
	<div region="west" border="true" split="true" title="导航" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
			<div title="个人中心">
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_personal_page"
					class="cs-navi-tab">查看个人信息</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_update_pwd_page"
					class="cs-navi-tab">修改密码</a>
				<p></p>
			</div>
			<div title="商品管理">
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_product_page"
					class="cs-navi-tab">查看所有商品</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_add_product_page"
					class="cs-navi-tab">添加商品</a>
				<p></p>
			</div>
			<div title="活动管理">
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_activity_page"
					class="cs-navi-tab">查看所有活动</a>
				<p></p>
				<a href="javascript:void(0);" src="<%=path %>/supply/supply_add_activity_page"
